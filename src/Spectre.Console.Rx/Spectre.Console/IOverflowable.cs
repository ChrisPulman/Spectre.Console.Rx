...
public static class OverflowableExtensions
{
        ...
        where T : class, IOverflowable
    {
        ...
        return Overflow(obj, Spectre.Console.Rx.Overflow.Fold);
    }
        ...
        where T : class, IOverflowable
    {
        ...
        return Overflow(obj, Spectre.Console.Rx.Overflow.Crop);
    }
        ...
        where T : class, IOverflowable
    {
        ...
        return Overflow(obj, Spectre.Console.Rx.Overflow.Ellipsis);
    }
