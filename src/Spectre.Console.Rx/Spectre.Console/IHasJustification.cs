...
public static class HasJustificationExtensions
{
        ...
        where T : class, IHasJustification
    {
        ...
        obj.Justification = Spectre.Console.Rx.Justify.Left;
        return obj;
    }
        ...
        where T : class, IHasJustification
    {
        ...
        obj.Justification = Spectre.Console.Rx.Justify.Center;
        return obj;
    }
        ...
        where T : class, IHasJustification
    {
        ...
        obj.Justification = Spectre.Console.Rx.Justify.Right;
        return obj;
    }
}
