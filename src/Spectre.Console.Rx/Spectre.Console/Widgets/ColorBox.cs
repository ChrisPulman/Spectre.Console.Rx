...
public sealed class ColorBox(int height) : Renderable
{
    ...
    private static (float r, float g, float b) ColorFromHSL(double h, double l, double s)
    {
        double r = 0, g = 0, b = 0;
        if (l != 0)
        {
