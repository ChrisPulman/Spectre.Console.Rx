...
public static partial class AnsiConsoleExtensions
{
    ...
    public static Recorder CreateRecorder(this IAnsiConsole console) => new(console);
    ...
    /// <param name="console">The console to write to.</param>
    /// <param name="text">The text to write.</param>
    public static void WriteLine(this IAnsiConsole console, string text) => WriteLine(console, text, Style.Plain);
