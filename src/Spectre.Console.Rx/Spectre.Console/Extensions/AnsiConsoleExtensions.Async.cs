...
public static class SpinnerExtensions
{
        ...
        IAnsiConsole? ansiConsole = null)
    {
        ...
        await SpinnerInternal<object>(task, spinner ?? Spectre.Console.Rx.Spinner.Known.Default, style, ansiConsole);
    }
        ...
        IAnsiConsole? ansiConsole = null)
    {
        ...
        return (await SpinnerInternal<T>(task, spinner ?? Spectre.Console.Rx.Spinner.Known.Default, style, ansiConsole))!;
    }
