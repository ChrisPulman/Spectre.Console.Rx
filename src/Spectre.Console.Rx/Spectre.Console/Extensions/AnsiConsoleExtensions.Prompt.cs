...
public static partial class AnsiConsoleExtensions
{
    ...
    /// <returns>The prompt input result.</returns>
    public static T Ask<T>(this IAnsiConsole console, string prompt) => new TextPrompt<T>(prompt).Show(console);
    ...
    public static bool Confirm(this IAnsiConsole console, string prompt, bool defaultValue = true) => new ConfirmationPrompt(prompt)
    {
