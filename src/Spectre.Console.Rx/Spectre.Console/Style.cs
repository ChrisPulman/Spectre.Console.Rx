...
public sealed class Style(Color? foreground = null, Color? background = null, Decoration? decoration = null, string? link = null) : IEquatable<Style>
{
    /// <summary>
    ...
    /// </summary>
    public Color Foreground { get; } = foreground ?? Color.Default;

    /// <summary>
    /// Gets the background color.
    /// </summary>
    public Color Background { get; } = background ?? Color.Default;

    /// <summary>
    /// Gets the text decoration.
    /// </summary>
    public Decoration Decoration { get; } = decoration ?? Decoration.None;
    ...
    public static implicit operator Style(string style) => Parse(style);

    /// <summary>
    /// Implicitly converts <see cref="Color"/> into a <see cref="Style"/> with a foreground color.
    /// </summary>
    /// <param name="color">The foreground color.</param>
    public static implicit operator Style(Color color) => new(foreground: color);
    ...
    public static Style WithForeground(Color color) => new(foreground: color);
    ...
    [Obsolete("Use ctor(..) instead")]
    public static Style WithBackground(Color color) => new(background: color);
    ...
    [Obsolete("Use ctor(..) instead")]
    public static Style WithDecoration(Decoration decoration) => new(decoration: decoration);
    ...
    [Obsolete("Use ctor(..) instead")]
    public static Style WithLink(string link) => new(link: link);
    ...
    public static Style Parse(string text) => StyleParser.Parse(text);
    ...
    public static bool TryParse(string text, out Style? result) => StyleParser.TryParse(text, out result);
