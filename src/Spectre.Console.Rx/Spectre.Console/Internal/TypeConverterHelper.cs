...
internal static class TypeConverterHelper
{
    ...
    internal static bool IsGetConverterSupported =>
        !AppContext.TryGetSwitch("Spectre.Console.Rx.TypeConverterHelper.IsGetConverterSupported ", out var enabled) || enabled;
    ...
    public static TypeConverter GetTypeConverter<T>()
    {
        ...
        static TypeConverter? GetConverter()
        {
            ...
            {
                // Spectre.Console.Rx.TypeConverterHelper.IsGetConverterSupported has been set so
