...
internal static class AnsiSequences
{
    ...
    /// </remarks>
    /// <returns>The ANSI escape code.</returns>
    public static string ED(int code) => $"{CSI}{code}J";
    ...
    /// <returns>The ANSI escape code.</returns>
    public static string CUU(int steps) => $"{CSI}{steps}A";
    ...
    /// <returns>The ANSI escape code.</returns>
    public static string CUD(int steps) => $"{CSI}{steps}B";
    ...
    /// <returns>The ANSI escape code.</returns>
    public static string CUF(int steps) => $"{CSI}{steps}C";
    ...
    /// <returns>The ANSI escape code.</returns>
    public static string CUB(int steps) => $"{CSI}{steps}D";
    ...
    /// </remarks>
    /// <returns>The ANSI escape code.</returns>
    public static string CUP(int line, int column) => $"{CSI}{line};{column}H";
    ...
    /// </remarks>
    /// <returns>The ANSI escape code.</returns>
    public static string RM(int code) => $"{CSI}?{code}l";
    ...
    /// </remarks>
    /// <returns>The ANSI escape code.</returns>
    public static string SM(int code) => $"{CSI}?{code}h";
    ...
    /// </remarks>
    /// <returns>The ANSI escape code.</returns>
    public static string EL(int code) => $"{CSI}{code}K";
}