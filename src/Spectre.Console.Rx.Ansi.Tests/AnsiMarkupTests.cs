...
public sealed class AnsiMarkupTests
{
    ...
    {
        [Test]
        [Arguments("[yellow]Hello[", "Encountered malformed markup tag at position 14.")]
        [Arguments("[yellow]Hello[/", "Encountered malformed markup tag at position 15.")]
        [Arguments("[yellow]Hello[/foo", "Encountered malformed markup tag at position 15.")]
        [Arguments("[yellow Hello", "Encountered malformed markup tag at position 13.")]
        [Arguments("[yellow[green]]Hello", "Encountered malformed markup tag at position 7.")]
    ...
    public sealed class TheRemoveMethod
    {
        [Test]
        [Arguments("Hello World", "Hello World")]
        [Arguments("Hello [blue]World", "Hello World")]
        [Arguments("Hello [blue]World[/]", "Hello World")]
        [Arguments("[grey][[grey]][/][white][[white]][/]", "[grey][white]")]
    ...
    public sealed class TheHighlightMethod
    {
        ...
        [Test]
        [Arguments("Hello [[World]]", "World", "Hello [[[bold on yellow]World[/]]]")]
        [Arguments("[[Prod]] Service", "Prod", "[[[bold on yellow]Prod[/]]] Service")]
        [Arguments("Item [[A]] and [[B]]", "A", "Item [[[bold on yellow]A[/]]] and [[B]]")]
    ...
    public sealed class TheWriteMethod
    {
        ...
        [Test]
        [Arguments("[yellow]Hello[/]", "\e[93mHello\e[0m")]
        [Arguments("[yellow]Hello [italic]World[/]![/]", "\e[93mHello \e[0m\e[3;93mWorld\e[0m\e[93m!\e[0m")]
        ...
        [Test]
        [Arguments("[yellow]Hello [[ World[/]", "\e[93mHello [ World\e[0m")]
