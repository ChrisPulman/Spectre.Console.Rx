...
public sealed class StyleTests
{
    ...
    public sealed class TheParseMethod
    {
        ...
        [Test]
        [Arguments("bold", Decoration.Bold)]
        [Arguments("b", Decoration.Bold)]
        [Arguments("dim", Decoration.Dim)]
        [Arguments("i", Decoration.Italic)]
        [Arguments("italic", Decoration.Italic)]
        [Arguments("underline", Decoration.Underline)]
        [Arguments("u", Decoration.Underline)]
        [Arguments("invert", Decoration.Invert)]
        [Arguments("conceal", Decoration.Conceal)]
        [Arguments("slowblink", Decoration.SlowBlink)]
        [Arguments("rapidblink", Decoration.RapidBlink)]
        [Arguments("strikethrough", Decoration.Strikethrough)]
        [Arguments("s", Decoration.Strikethrough)]
        ...
        [Test]
        [Arguments("#FF0000 on #0000FF")]
        [Arguments("#F00 on #00F")]
        ...
        [Test]
        [Arguments("#", "Invalid hex color '#'.")]
        [Arguments("#FF00FF00FF", "Invalid hex color '#FF00FF00FF'.")]
        [Arguments("#FOO", "Invalid hex color '#FOO'. Could not find any recognizable digits.")]
        ...
        [Test]
        [Arguments("rgb(255,0,0) on rgb(0,0,255)")]
        ...
        [Test]
        [Arguments("-12", "Color number must be greater than or equal to 0 (was -12)")]
        [Arguments("256", "Color number must be less than or equal to 255 (was 256)")]
        ...
        [Test]
        [Arguments("rgb()", "Invalid RGB color 'rgb()'.")]
        [Arguments("rgb(", "Invalid RGB color 'rgb('.")]
        [Arguments("rgb(255)", "Invalid RGB color 'rgb(255)'.")]
        [Arguments("rgb(255,255)", "Invalid RGB color 'rgb(255,255)'.")]
        [Arguments("rgb(255,255,255", "Invalid RGB color 'rgb(255,255,255'.")]
        [Arguments("rgb(A,B,C)", "Invalid RGB color 'rgb(A,B,C)'.")]
